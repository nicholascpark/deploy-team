...
- `infrastructure_upgrade_available` → Low priority. New invisilink version available. Post to `channels/general.md` so Founder is aware. No immediate action — human runs `/flash` to upgrade.
